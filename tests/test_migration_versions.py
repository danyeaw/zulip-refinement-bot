...
class TestInitialSchemaMigration:
    """Test the initial schema migration (001)."""
    ...
    def test_up_migration(self, temp_db: Path):
    ...
    def test_down_migration(self, temp_db: Path):
    ...
    def test_validation(self, temp_db: Path):
    ...
    def test_indexes_created(self, temp_db: Path):
...
class TestAddMessageIdMigration:
    ...
    def test_up_migration_idempotent(self, temp_db: Path):
...
class TestBatchVotersMigration:
    ...
    def test_data_migration(self, temp_db: Path):
...
class TestFinalEstimatesMigration:
...
class TestAllMigrationsIntegration:
    """Integration tests for all migrations together."""

    def test_all_migrations_run_successfully(self, migration_runner: MigrationRunner):
        """Test that all migrations can be applied successfully."""
        applied = migration_runner.run_migrations()
        expected_versions = ["001", "002", "003", "004"]
        assert applied == expected_versions

    def test_all_migrations_validate(self, migration_runner: MigrationRunner):
        """Test that all applied migrations validate successfully."""
        migration_runner.run_migrations()
        assert migration_runner.validate_migrations() is True

    def test_migration_order_dependency(self, migration_runner: MigrationRunner):
    ...
    def test_complete_schema_after_all_migrations(self, temp_db: Path):
    ...
    def test_rollback_all_migrations(self, migration_runner: MigrationRunner):
        """Test rolling back all migrations in reverse order."""
        # Apply all migrations
        migration_runner.run_migrations()

        # Rollback in reverse order
        versions_to_rollback = ["004", "003", "002", "001"]
    ...
    def test_partial_rollback_and_reapply(self, migration_runner: MigrationRunner):
        ...
        assert final_applied == {"001", "002", "003", "004"}
