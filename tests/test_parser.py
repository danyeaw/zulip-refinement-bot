...
class TestInputParser:
    ...
    @pytest.fixture
    def parser(self, test_config: Config, mock_github_api: MagicMock) -> InputParser:
        """Create an input parser with mocked dependencies."""
        return InputParser(test_config, mock_github_api)

    def test_valid_single_issue(self, parser: InputParser, mock_github_api: MagicMock):
...
https://github.com/conda/conda/issues/15169"""
    ...
    def test_valid_multiple_issues(self, parser: InputParser, mock_github_api: MagicMock):
...
https://github.com/conda/conda/issues/15167"""
    ...
    def test_invalid_format(self, parser: InputParser):
    ...
    def test_duplicate_issue_numbers(self, parser: InputParser, mock_github_api: MagicMock):
...
https://github.com/conda/conda/issues/15169"""
    ...
    def test_title_truncation(self, parser: InputParser, mock_github_api: MagicMock):
    ...
    def test_github_api_failure(self, parser: InputParser, mock_github_api: MagicMock):
...
https://github.com/conda/conda/issues/99999"""
    ...
    def test_parse_estimation_input_valid(self, parser: InputParser):
