...
def test_batch_voters_add_batch_voters(db_manager: DatabaseManager):
...
def test_batch_voters_get_batch_voters_empty(db_manager: DatabaseManager):
...
def test_batch_voters_add_single_voter_to_batch(db_manager: DatabaseManager):
...
def test_batch_voters_add_duplicate_voter_to_batch(db_manager: DatabaseManager):
...
def test_batch_voters_isolated_between_batches(db_manager: DatabaseManager):
...
def test_batch_voters_sorted_alphabetically(db_manager: DatabaseManager):
...
def test_batch_voters_add_batch_voters_pool(db_pool: DatabaseManager):
...
def test_batch_voters_add_single_voter_pool(db_pool: DatabaseManager):
...
def test_batch_voters_pool_cleanup(db_pool: DatabaseManager):
...
def test_batch_voters_batch_creation_with_voters(db_manager: DatabaseManager):
...
def test_batch_voters_votes_with_batch_voters(db_manager: DatabaseManager):
...
def test_batch_voters_batch_completion_with_voters(db_manager: DatabaseManager):
...
def test_parse_voter_name_with_mention_format():
...
def test_add_voter_updates_batch_message():
...
def test_remove_voter_updates_batch_message():
    ...
    with (
        ...
        mock_batch_service.database.remove_voter_from_batch.assert_called_once_with(1, "olduser")
...
def test_no_update_when_voter_already_exists():
    ...
    with (
        ...
        mock_batch_service.database.add_voter_to_batch.assert_called_once_with(1, "existing_user")
