"""Webhook-compatible version of the Zulip Refinement Bot."""
...
class WebhookRefinementBot:
    """Webhook-compatible version of the refinement bot."""

    def __init__(self, config: Config) -> None:
        """Initialize the webhook refinement bot.
        ...
        logger.info(
            "Webhook refinement bot initialized", config=config.dict(exclude={"zulip_api_key"})
        )
...
• Batch completes automatically when all voters submit or when deadline expires"""
    ...
    def stop(self) -> None:
        ...
        logger.info("Stopping Webhook Zulip Refinement Bot")
