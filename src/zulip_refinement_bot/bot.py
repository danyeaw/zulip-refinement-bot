...
class RefinementBot:
    ...
    def handle_message(self, message: Dict[str, Any]) -> None:
        ...
        try:
            ...
            self._send_reply(message, "❌ An error occurred processing your message. Please try again.")
    ...
    def _handle_start_batch(self, message: Dict[str, Any], content: str) -> None:
        ...
        if active_batch:
            self._send_reply(message, "❌ Active batch already running. Use 'status' to check progress.")
            return
